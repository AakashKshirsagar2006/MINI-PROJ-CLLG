...
//           className="w-8 h-8 rounded-full bg-red-50 text-red-500 flex items-center justify-center hover:bg-red-100 transition active:scale-95">
...
//               disabled={loadingState || (!availability)|| (qty<=1)}
//               className="w-8 h-8 rounded-full bg-slate-100 text-slate-600 flex items-center justify-center hover:bg-slate-200 transition active:scale-95">
//               <HiMinus size={14} />
//             </button>
...
//             <button
//               onClick={() => updateQuantity((_id.toString()),+1)}
//               disabled={loadingState || (!availability) || (totalQty>=15)}
//               className="w-8 h-8 rounded-full bg-slate-900 text-white flex items-center justify-center hover:bg-orange-600 transition active:scale-95">
//               <HiPlus size={14} />
//             </button>
//           </div>
//         </div>
