const HomePageHero = ()=>{
  return(
     <section className="relative mt-2 md:mt-10 rounded-[2.5rem] overflow-hidden h-[320px] md:h-[500px] flex items-end p-8 md:p-16 group shadow-xl shadow-slate-200">
  <img 
